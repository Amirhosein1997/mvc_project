                ...
                <div class="col-md-10">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">اخذ لینک خودکار رویداد آنلاین</h3>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div data-toggle="buttons">
                                            <label class="form-group col-md-6 btn btn-facebook"><input type="checkbox" autocomplete="off" required> دریافت لینک خودکار مدیریت رویداد</label>
                                            <label class="form-group col-md-6 btn btn-success"><input type="checkbox" autocomplete="off" required> دریافت لینک خودکار برگزارکندده رویداد </label>
                                        </div>
                                    </div>

                                </div>
                                <div>
                                    <input type="submit" name="submit" class="form-control btn btn-primary" value="دریافت لینک خودکار اتاق در سامانه برتا">
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">لیست لینک خودکار اتاق آنلاین</h3>
                        </div>
                        <div class="box-body">
                            <div class="box-body no-padding">
                                <table class="table table-hover">
                                    ...
                                    <tr class="form-group">
                                        ...
                                        <th scope="col"><button class="form-control">لینک مدیریت</button></th>
                                        <th scope="col"><button class="form-control">لینک برگزارکننده</button></th>
                                        <th scope="col"><button class="form-control">وضعیت</button></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php
                                    foreach ($list_webinar_idirect_link as $key=>$webinar):
                                        ?>
                                        <tr>
                                            ...
                                            <th scope="row"><a class="form-control btn btn-success" href="<?php echo $webinar->admin_link;?>" target="_blank">دریافت لینک</a></th>
                                            <th scope="row"><a class="form-control btn btn-success" href="<?php echo $webinar->presenter_link;?>" target="_blank">دریافت لینک</a></th>

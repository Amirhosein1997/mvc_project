                ...
                <div class="col-md-10">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">لیست وبینار های درحال برگزاری</h3>
                        </div>
                        <table class="table table-hover">
                            ...
                            <?php
                             ...
                             ?>
                            <tr>
                                <td><button class="form-control"><?php echo $key + 1?></button></td>
                                <td><button class="form-control btn btn-linkedin"><?php echo $webinar->title ?></button></td>
                                <td><button class="form-control btn btn-warning"><?php echo $user->name.' '.$user->family ?></button></td>
                                <td><button class="form-control btn btn-danger"><?php echo $webinar->date_submit?></button></td>
								<td><button class="btn btn-success form-control"><?php echo $webinar->click?> نفر</button></td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
											...
											<li><a href="<?php $this->url('manage_webinars/list_certificate/'."$webinar->id".'/'."$user->id") ?>">صدور گواهینامه رسمی</a></li>
											...
											<li><a href="<?php $this->url('manage_webinars/change_status_event/'."$webinar->id") ?>">انتقال وبینار به برگزار شده</a></li>
											<li><a href="<?php $this->url('manage_webinars/change_status_event_archive/'."$webinar->id") ?>">انتقال وبینار به بایگانی</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>

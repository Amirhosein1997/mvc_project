...
#loader {
  ...
  z-index: 10000;
    ...
    <title>سامانه جامع برتا |افزودن فایل ضمیمه  </title>
            ...
            <div class="row" style="margin-top: 3%;">
                ...
                <div class="col-md-10">
                    <div class="box box-primary">
						...
						فایل ضمیمه با موفقیت بارگذاری شد.
						</div>
						<?php else: ?>
                        <div class="box-header with-border">
                            <h3 class="box-title">افزودن فایل ضمیمه</h3>
                        </div>
							<form method="post" action="#" enctype="multipart/form-data">
							<div class="file_wrapper custom-file">
								<input type="file" class="custom-file-input" name="attach" required>
								<label class="custom-file-label" for="customFile1">افزودن فایل ضمیمه اتاق جلسه</label>
							</div>
							<input type="hidden" name="upload_attach" value="<?php echo $code_meeting; ?>">
							<button type="submit" class="btn btn-success form-control">بارگذاری فایل ضمیمه</button>								
							</form>
						<?php endif; ?>	
                    </div>
